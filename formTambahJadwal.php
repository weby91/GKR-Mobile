...
<form id="rendered-form" action="setJadwalPelayanan.php" method="post">
  <div class="rendered-form">
	...
	<div class="form-group field-button-1472405594993"><button type="submit" subtype="submit" class="btn btn-default button-input" name="submit" id="submit">Save</button></div>
  </div>
</form>